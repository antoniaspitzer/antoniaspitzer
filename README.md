...
<img src="https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,angular,vue,nodejs,express,php,symfony,java,python,cpp,sql,mongodb,docker,github,vscode,figma&perline=10" alt="tech stack"> </div>
...
<sub>`are you interested? Contact me!`</sub>
